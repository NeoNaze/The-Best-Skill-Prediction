...
module.exports = {
	...
	1: { // Lancer
		...
		18: { // Shield Barrage
			0: {
				...
				distance: 122.66,	//Popori: 92.39, M.Aman: 95, M.Human,F.Aman: 100.125
				noInterrupt: [2],
				abnormals: {
					201550: { speed: 1.2 }
				}
			...
			1: {
				length: 800,
				distance: 66.04,	//M.Human: 74.836, F.Aman: 74.837, M.Aman: 87, Popori: 89.462
				noInterrupt: [2]
			}
		},
	...
	3: { // Berserker
		...
		15: { // Vampiric Blow
            ...
            0: {             
                type: 'charging',       
				//length: [800, 2700], //if you can only charge 1 tick
				//length: [800, 800, 2700], //if you can only charge 2 ticks
				length: [800, 800, 800, 2700], //if you can charge 3 ticks
		...
		18: { // Lethal Strike (TODO: Check)
			...
			0: {
				...
				//length: [800, 2700], //if you can only charge 1 tick
				//length: [800, 800, 2700], //if you can only charge 2 ticks
				length: [800, 800, 800, 2700], //if you can charge 3 ticks and overcharge	
	...
	4: { // Sorcerer
		...
		2: { // Frost Sphere
			0: { length: 910 } // Popori/M.Casta/M.Helf/M.Human/F.Casta/F.Aman/F.Helf/F.Human: 810 | Baraka: 910 | Elin: 1010 | M.Aman: 1255
		},
		3: { // Lightning Trap
			0: {
				length: 1300,
		...
		6: { // Meteor Strike
			0: {
				length: 3925, // Elin: 3725 | Any other race: 3925
				glyphs: {
					25003: { speed: 1.17 },
					25069: { speed: 1.25 }
				},
