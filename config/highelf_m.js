...
module.exports = {
	0: { // Warrior
		...
		36: { // Rain of Blows (Deadly Gamble)
			'*': { distance: 152.733 },
			0: { 
				length: 2800,	//longer than regular but it is true
				noInterrupt: [32]
		    },
			30: { length: 2000 }
		},
	...
	1: { // Lancer
		...
		3: { // Onslaught
			'*': {
				distance: [0, 100, 100, 100, 100, 16.278],
		...
		18: { // Shield Barrage
			0: {
				length: 525,
				distance: 102.701,	//Popori: 92.39, M.Aman: 95, M.Human,F.Aman: 100.125
				noInterrupt: [2],
				abnormals: {
					201550: { speed: 1.2 }
				}
			...
			1: {
				length: 800,
				distance: 80.428,	//M.Human: 74.836, F.Aman: 74.837, M.Aman: 87, Popori: 89.462
				noInterrupt: [2]
			}
		},
	...
	4: { // Sorcerer
		...
		2: { // Frost Sphere
			0: { length: 810 } // Popori/M.Casta/M.Helf/M.Human/F.Casta/F.Aman/F.Helf/F.Human: 810 | Baraka: 910 | Elin: 1010 | M.Aman: 1255
		},
		3: { // Lightning Trap
			0: {
				length: 1300,
		...
		32: { // Meteor Shower
			'*': {
				length: 6750, // Elin: 6475 | M.Helf/F.Casta: 6750/6775
				glyphs: {
					25003: { speed: 1.17 },
					25069: { speed: 1.25 }
				},
