...
module.exports = {
	...
	1: { // Lancer
		...
		3: { // Onslaught
			'*': {
				distance: [0, 100, 100, 100, 100, 13.154],
		...
		18: { // Shield Barrage
			...
			1: {
				length: 800,
				distance: 87,	//M.Human: 74.836, F.Aman: 74.837, M.Aman: 87, Popori: 89.462
				noInterrupt: [2]
			}
		},
	...
	2: { // Slayer
		...
		4: { // Evasive Roll
			'*': { 
				length: 915,	//Popori: 1185, Other races: 905
				distance: 150,
				noInterrupt: [4],
				forceclip: true,
			},
	...
	4: { // Sorcerer
		...
		2: { // Frost Sphere
			0: { length: 1255 } // Popori/M.Casta/M.Helf/M.Human/F.Casta/F.Aman/F.Helf/F.Human: 810 | Baraka: 910 | Elin: 1010 | M.Aman: 1255
		},
		3: { // Lightning Trap
			0: {
				length: 1300,
